...
class Parser(docutils.parsers.Parser):
    ...
    settings_spec = (
        ...
        None,
        (('Recognize and link to standalone PSEP references (like "PSEP 258").',
          ['--psep-references'],
          {'action': 'store_true', 'validator': frontend.validate_boolean}),
         ('Base URL for PSEP references '
          '(default "http://www.pyside.org/docs/pseps/").',
          ['--psep-base-url'],
          {'metavar': '<URL>', 'default': 'http://www.pyside.org/docs/pseps/',
           'validator': frontend.validate_url_trailing_slash}),
         ('Template for PSEP file part of URL. (default "psep-%04d.txt")',
          ['--psep-file-url-template'],
          {'metavar': '<URL>', 'default': 'psep-%04d.txt'}),
