    ...
    settings_spec = (
        ...
        (('Recognize and link to standalone PSEP references (like "PSEP 258").',
         ...
         ('Base URL for PSEP references '
          '(default "http://www.python.org/dev/pseps/").',
          ['--psep-base-url'],
          {'metavar': '<URL>', 'default': 'http://www.python.org/dev/pseps/',
           'validator': frontend.validate_url_trailing_slash}),
         ('Template for PSEP file part of URL. (default "psep-%04d")',
          ['--psep-file-url-template'],
          {'metavar': '<URL>', 'default': 'psep-%04d'}),
